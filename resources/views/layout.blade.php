...
<html lang="en">
  ...
  <head>
    ...
    <title>CONG DOAN - Hiệu sách tuổi thơ</title>
        ...
        <div class="container">
                    <nav class="main-nav">
                        ...
                        <a href="{{url('home')}}" class="logo">
                            <img width="110px" src="{{ asset('assets/images/logo.png')}}">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="/#author">Author</a></li>
