...
@section('container')
    <a href="/add/charge" type="button" class="btn btn-success" style="width:170px;height:35px;padding-top:9px;">+ Add
        Charge</a>
                                ...
                                @foreach ($charges as $charge)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ asset('/admin/charge/delete/' . $charge->id) }}"
