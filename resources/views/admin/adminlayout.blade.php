    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                @if (Auth::user()->usertype != 2)
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="/admin/book-menu">
                            <span class="menu-icon">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="/admin/orders-incomplete">Pending
                                    Orders</a></li>
                            <li class="nav-item"> <a class="nav-link" href="/orders/process">Processing Order</a>
                            </li>
                ...
                <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
                    ...
                    <ul class="navbar-nav w-100">
                        <li class="nav-item w-100">
                            @if (Str::contains(request()->url(), 'orders-incomplete'))
                                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex" method="get"
                                    action="{{ asset('/admin/orders-incomplete') }}" name="search">
                                @elseif (Str::contains(request()->url(), 'customer'))
                                    <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex" method="get"
                                        action="{{ asset('/customer') }}" name="search">
                                    @else
                                        <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex" method="get"
                                            action="{{ asset('admin/book-menu') }}" name="search">
                            @endif
