    ...
    <div class="row">
        <div class="span8 well invoice-body">
            <table class="table table-bordered" id="customers"
                style="border:2px solid;margin-left:20px;margin-right:20px !important;width:95%!important;">
                <thead>
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr style="border:2px solid;">
                            ...
                            <td style="margin-left:20px;">{{ $product->subtotal }} VND</td>
                        </tr>
                    @endforeach
                    @foreach ($extra_charge as $charge)
                        <tr style="border:2px solid;">
                            ...
                            <td style="margin-left:20px;"></td>
                            <td style="margin-left:20px;">{{ $charge->price }} VND</td>
                        </tr>
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td><strong>{{ $without_discount_price }} VND</strong></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong>{{ $discount_price }} VND</strong></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                    </tr>
    ...
    <div class="row" style="margin-left:20px;">
        ...
        <div class="span3">
            <strong>Email:</strong> <a
                href="sajeebchakraborty.cse2000@gmail.com">sajeebchakraborty.cse2000@gmail.com</a>
        </div>
