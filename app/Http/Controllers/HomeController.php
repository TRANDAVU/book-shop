...
class HomeController extends Controller
{
    ...
    public function redirects(){
        ...
        if($usertype!='0')
    	{
    		...
    		return view('admin.dashboard',compact('pending_order','total','product','cash_on_payment','online_payment','customer','delivery_boy','admin','processing_order','cancel_order','complete_order'));
    	}
        else{
